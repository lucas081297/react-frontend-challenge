...
export const Route = createFileRoute('/__auth/movies/popular')({
...
function PopularMovies() {
  ...
  const { data, isLoading, isFetching } = getPopularMovies(page)
  ...
  return (
    <main className="flex flex-col gap-8 p-8 bg-surface-variant/10 min-h-full">
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <h1 className="text-4xl font-extrabold">Filmes Populares</h1>
        {allMovies.length > 0 && (
          <FilterPanel
            movies={allMovies}
